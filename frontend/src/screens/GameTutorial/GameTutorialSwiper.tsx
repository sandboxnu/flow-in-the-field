...
import GameTutorialPage from "./GameTutorialPage";

// Images to display on pairing and selecting tutorial pages
const tutorialImages = {
  page1: require("../../assets/tutorial-images/tutorial-page-1.png"),
  page2: require("../../assets/tutorial-images/tutorial-page-2.png"),
  page3: require("../../assets/tutorial-images/tutorial-page-3.png"),
  page5Pairing: require("../../assets/tutorial-images/pairing-tutorial-page-5.png"),
  page5Selecting: require("../../assets/tutorial-images/selecting-tutorial-page-5.png"),
  page6: require("../../assets/tutorial-images/tutorial-page-6.png"),
  page7: require("../../assets/tutorial-images/tutorial-page-7.png"),
};
...
export default function GameTutorialSwiper({
  isPairing,
  onFinish,
