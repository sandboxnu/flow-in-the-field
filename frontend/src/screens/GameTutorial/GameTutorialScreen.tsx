    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={{ width: "95%" }}>
          ...
          {hasNavButton && (
            <RegularText style={{ ...styles.content, textAlign: "center" }}>
              {screenContent}
            </RegularText>
          )}
        </View>
      ...
      <View style={styles.imageAndButtonContainer}>
        ...
        {imagePath && <Image style={styles.image} source={imagePath} />}
        ...
        {hasNavButton && (
          <Pressable onPress={handleTutorialFinish} style={styles.button}>
            <MediumText style={styles.buttonContent}>
              {navButtonTitle}
            </MediumText>
          </Pressable>
        )}
